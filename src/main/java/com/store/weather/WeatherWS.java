 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/wsTest/WeatherWS.asmx.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/wsTest/WeatherWS.asmx.xml");
