...
package com.store.ws.helloWorld;
 ...
 * generated in the com.store.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://cxf.store.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://cxf.store.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.store.ws
     * 
     */
     ...
     *
     */
    @XmlElementDecl(namespace = "http://cxf.store.com/", name = "say")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://cxf.store.com/", name = "sayResponse")
