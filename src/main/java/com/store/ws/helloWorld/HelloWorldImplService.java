 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://impl.cxf.store.com/", wsdlLocation = "http://localhost:8080/store-cxh/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://impl.cxf.store.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/store-cxh/ws/hello?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://impl.cxf.store.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.cxf.store.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
